...
BRIDGE = {
    ...
    PLAYER_DROPPED = 'hw_utils:bridge:playerDropped',
    PLAYER_LOADED = 'hw_utils:bridge:playerLoaded',
    PLAYER_DEATH = 'hw_utils:bridge:onPlayerDeath',
    PLAYER_JOB = 'hw_utils:bridge:setJob',
}

--| Handlers |--
RegisterNetEvent('esx:playerDropped', function(player, reason)
    TriggerEvent('hw_utils:bridge:playerDropped', player, reason)
end)

RegisterNetEvent('esx:playerLoaded', function(player, xPlayer, isNew)
    TriggerEvent('hw_utils:bridge:playerLoaded', player, xPlayer, isNew)
end)

RegisterNetEvent('esx:setJob', function(player, job, lastJob)
    TriggerEvent('hw_utils:bridge:setJob', player, job, lastJob)
end)

RegisterNetEvent('esx:onPlayerDeath', function(data)
    TriggerEvent('hw_utils:bridge:onPlayerDeath', source, data)
end)
